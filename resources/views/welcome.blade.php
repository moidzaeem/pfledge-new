...
<body>
    ...
    @guest
        <div class="index2-login-container ">
                ...
                <form action="{{url('login')}}" method="post">
                    ...
                    <div class="index2-input-container">
                        ...
                        <div class="index2-password-container">
                            <input type="password" id="index2PasswordInput" name="password" placeholder="Ihr Passwort">
            ...
            @guest
                <div class="index2-input-mein-btn text-center mt-3"><button> <a href="{{ route('mein-pflegePur') }}"
                            style="text-decoration: none;color:white"> Zur
