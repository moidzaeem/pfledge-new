...
<body>
    ...
    <div class="online-rechner-section3-container" style="padding-top:0px;margin-top:0px;background-color:{{$bgcolor;}};">
        <div class="online-rechner-section3-sub-container">
            ...
            <form action="{{ route('partner.rechnerpflegegrad') }}" method="POST" target="result-iframe">            
                @csrf
                <!-- ######################## MODULE 1 FORM ######################## -->
...
<strong>Fähigkeit nicht vorhanden:</strong> Ein Gespräch mit der Person, das über einfache Mitteilungen hinausgeht, ist auch unter Einsatz bonverbaler Kommunikation kaum oder nicht möglich."
                ...
                <div class="online-rechner-section3-form" id="module6Form">
                    ...
                    <div class="text-center">                                                                           
                        <button class="online-rechner-section3-form-btn active-btn2" style="background-color: {{$bgcolor2;}}" type="submit">
                            Pflegegrad berechnen
                        </button>
                    </div>
                </div>
            ...
            <div class="online-rechner-section3-bottom">
                ...
                <div class="online-rechner-section3-inner-bottom" style="background-color:{{$bgcolor2;}};">
                    <div class="row">
                        <div class="col-lg-8 ">
