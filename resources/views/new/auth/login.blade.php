            ...
            <div class="index2-login-cont " style="background-color: rgba(255, 255, 255, 1) !important;">
                ...
                <form action="{{ url('/login') }}" method="POST">
                    ...
                    <div class="index2-input-container">
                        <div class="index2-eamil-input"><input type="email" name="email" placeholder="Ihre E-Mail">
                        </div>
                        <div class="index2-password-container">
                            <input type="password" name="password" id="index2PasswordInput" placeholder="Ihr Passwort">
                    ...
                    <div class="index2-login-btn"><button type="submit">Login</button></div>
                </form>
