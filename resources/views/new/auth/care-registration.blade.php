...
<body style="background-color: #b22222">
    ...
    margin-top: 3rem;"><img
        ...
        <div class="index2-login-cont registration2-cont " style="background-color: rgba(255, 255, 255, 1) !important;">
            ...
            <form action="{{ route('register.care.details.store') }}" method="POST" id="registerCareForm">
                @csrf
                <div class="registration2-step registration2-active2">
                    ...
                    <div class="registration2-radio-group">
                        <label class="registration2-radio">
                            <input type="radio" checked name="who_needs_care" value="my_self">
                            <span class="registration2-custom-radio"></span> Ich selbst
                        </label>
                        <label class="registration2-radio">
                            <input type="radio" name="who_needs_care" value="other_person">
                            <span class="registration2-custom-radio"></span> Eine andere Person
                        </label>
                        <label class="registration2-radio">
                            <input type="radio" name="who_needs_care" value="no_one">
                ...
                <div class="registration2-step">
                    ...
                    <div class="registration2-step2-cont1">
                        ...
                        <div class="registration2-radio-group">
                            <label class="registration2-radio">
                                <input type="radio" checked name="is_already_care_level" value="yes">
                            ...
                            <div class="stepper-range-container">
                                ...
                                <input type="range" min="1" max="5" value="2"
                                    class="stepper-range-slider" id="stepper-range-slider">
                            </div>
                ...
                <div class="registration2-step">
                    ...
                    <div class="registration2-radio-group">
                        <label class="registration2-radio">
                            <input type="radio" checked name="care_type" value="home">
                            <span class="registration2-custom-radio"></span> Zu Hause
                        </label>
                        <label class="registration2-radio">
                            <input type="radio" name="care_type" value="at_home_with_support_from_a_care_service">
                            <span class="registration2-custom-radio"></span> Zu Hause mit Unterstützung durch einen
                            Pflegedienst
                        </label>
                        <label class="registration2-radio">
                            <input type="radio" name="care_type" value="inpatient_care">
                            <span class="registration2-custom-radio"></span> Stationäre Pflege (Pflegeheim oder
                            Betreutes
                            Wohnen)
                        </label>
                    </div>
                ...
                <div class="registration2-step">
                    ...
                    <div class="index2-registration-cont">
                        <div class="registration-top-checkbox-containers">
                            ...
                            <div class="index2-login-middle-cont index2-login-middle-cont11 "
                    ...
                    <div class="index2-input-container index2-input-container2 mt-2">
                        <div class="index2-eamil-input"><input type="tel" placeholder="Telefonnummer"
                                pattern="[0-9]{5}" maxlength="5"></div>
                        <div class="index2-eamil-input">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="fw-normal">Ihr Benutzerkonto wurde erfolgreich erstellt. Wir haben Ihnen eine
                            E-Mail
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="fw-bold mb-4">Herzlichen Glückwunsch! Ihr Benutzerkonto wurde erfolgreich aktiviert.
                        Sie
