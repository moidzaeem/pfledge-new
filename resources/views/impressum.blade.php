...
<body>
    ...
    <div class="impressum-section1">
        ...
        <div class="impressum-section1-accordion1">
            ...
            <div class="impressum-accordion1-bottom-div active">
                ...
                Kontakt: <br> Telefon: 05151 – 7909862 <br> E-Mail: info@pflegepur.de
            </div>
        </div>
        <div class="impressum-section1-accordion1">
            <div class="impressum-accordion1-top-div">
        ...
        <div class="impressum-section1-accordion1">
            ...
            <div class="impressum-accordion1-bottom-div">
                ...
                übermittelte oder gespeicherte fremde Informationen zu überwachen oder nach Umständen zu forschen, die auf eine rechtswidrige Tätigkeit hinweisen. <br>
                <br>
                Verpflichtungen zur Entfernung oder Sperrung der Nutzung von Informationen nach den allgemeinen Gesetzen bleiben hiervon unberührt. Eine diesbezügliche Haftung ist jedoch erst ab dem Zeitpunkt der Kenntnis einer konkreten
        ...
        <div class="impressum-section1-accordion1">
            ...
            <div class="impressum-accordion1-bottom-div">
                Die durch die Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht. Die Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung außerhalb der Grenzen des Urheberrechtes bedürfen der schriftlichen Zustimmung des jeweiligen Autors bzw. Erstellers. Downloads und
    ...
    <div class="impressum-section2">
        <div class="impressum-section1">
            ...
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">2. Name und Kontaktdaten des für die Verarbeitung Verantwortlichen
                    </div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret" class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
            ...
            <div class="impressum-section1-accordion1">
                ...
                <div class="impressum-accordion1-bottom-div ">
                    Wir verwenden in unserer Datenschutzerklärung unter anderem die folgenden Begriffe, die wir nachfolgend erläutern möchten: <br>
                    <br>
            ...
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">4. Erhebung und Speicherung personenbezogener Daten sowie Art und Zweck von deren Verwendung</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret" class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
                    a) beim Besuch unserer Website <br>
                    Beim Aufrufen unserer Website https://pflegepur.de werden durch den auf Ihrem Endgerät zum Einsatz kommenden Browser automatisch Informationen an den Server unserer Website gesendet. Diese Informationen werden temporär in einem sog. Logfile gespeichert. Folgende Informationen werden dabei ohne Ihr Zutun erfasst und bis zur automatisierten Löschung nach Verlassen unserer Webseite gespeichert: <br>
                    <br>
                    ...
                    <br>
                    Die Datenverarbeitung bei Zustandekommen eines Vertrages mit uns erfolgt nach Art. 6 Abs. 1 S. 1 lit. a DSGVO auf Grundlage Ihrer freiwillig erteilten Einwilligung bzw. nach Art. 6 Abs. 1 S. 1 lit. b DSG zur Vertragserfüllung. <br>
                    Sie können der Speicherung und Verwendung Ihrer Daten zu diesen Zwecken jederzeit durch eine Nachricht an die oben unter Ziffer 1. genannten Kontaktmöglichkeiten widersprechen. <br>
                    <br>
                    c) Hinweise zu elektronischer Post (E-Mail) <br>
                    Die Datenübertragung im Internet (z.B. bei der Kommunikation per E-Mail) kann Sicherheitslücken aufweisen. Informationen, die Sie unverschlüsselt per elektronische Post (E-Mail) an uns schicken, können von Dritten unterwegs gelesen, gespeichert und zweckentfremdet werden. Bitte senden Sie daher keine vertraulichen Informationen ohne Verwendung eines Verschlüsselungsprogramms. <br>
                    <br>
                    d) Passwortgeschützter Login-Bereich <br>
                    Der Kunde kann sich registrieren und nach Freischaltung seine eigene Mein PflegePur-Seite aufrufen. Im Rahmen der Registrierung und Nutzung der Plattform verarbeiten wir folgende personenbezogene Daten:<br />
                    – Geschlecht, Vorname, Nachname, E-Mail-Adresse, Passwort<br />
                    – Angaben zur Pflegebedürftigkeit und Pflegeform<br />
                    – Daten zur pflegenden Person (Name, Geburtsdatum, Adresse, Telefonnummer, Pflegekasse).
                    <br /><br />
                    Zweck der Datenverarbeitung Die erhobenen Daten dienen folgenden Zwecken:<br />
                    – Erstellung eines individuellen Benutzerportals<br />
                    – Simulation von Pflegeleistungen<br />
                    – Bereitstellung von Online-Rechnern, Musteranschreiben und Checklisten<br />
                    – Kommunikation mit dem Nutzer.
                    <br /><br />
                    Der Login-Bereich bietet den direkten Zugang zu gespeicherten personenbezogenen Daten und deren Verwaltung durch den Kunden. Zugangsdaten zum Login-Bereich müssen vertraulich behandelt und dürfen nicht an Dritte weitergegeben werden.
                    <br>
                    <br>
                    e) Sonstige Weitergabe von Daten <br>
                    Eine Übermittlung Ihrer personenbezogenen Daten an Dritte zu anderen als den im Folgenden aufgeführten Zwecken findet nicht statt. <br>
                    <br>
                    ...
                    – die Weitergabe nach Art. 6 Abs. 1 S. 1 lit. f DSGVO zur Geltendmachung, Ausübung oder Verteidigung von Rechtsansprächen erforderlich ist und kein Grund zur Annahme besteht, dass Sie ein überwiegendes schutzwürdiges Interesse an der Nichtweitergabe Ihrer Daten haben, <br>
            ...
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">6a. Facebook und Instagram</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret" class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
Im Rahmen unserer Datenschutzerklärung möchten wir Sie über die Verarbeitung personenbezogener Daten im Zusammenhang mit unseren Präsenzen auf Facebook und Instagram informieren.
<br /><br />
a. Allgemeines
<br />
Unsere Social-Media-Profile auf Facebook und Instagram dienen der Präsentation von PflegePur und der Interaktion mit Nutzern. Bitte beachten Sie, dass bei der Nutzung dieser Plattformen personenbezogene Daten durch die jeweiligen Anbieter verarbeitet werden.
<br /><br />
b. Verantwortliche Stellen
<br />
Für die Datenverarbeitung im Zusammenhang mit unseren Social-Media-Profilen sind wir gemeinsam mit Meta Platforms Ireland Limited, 4 Grand Canal Square, Dublin 2, Irland, verantwortlich.
<br /><br />
c. Datenverarbeitung und Zwecke
<br />
Bei Besuch unserer Profile erfasst Meta sogenannte Insights-Daten, die uns in anonymisierter Form zur Verfügung gestellt werden. Diese Daten ermöglichen es uns, die Nutzung unserer Profile zu analysieren und unser Angebot zu verbessern. Wir haben keinen Zugriff auf personenbezogene Daten einzelner Nutzer.
<br /><br />
Zudem können Sie über Funktionen wie Kommentare, Likes oder Direktnachrichten mit uns interagieren. Dabei werden die von Ihnen bereitgestellten Informationen verarbeitet, um auf Ihre Anliegen zu reagieren.
<br /><br />
d. Rechtsgrundlage
<br />
Die Verarbeitung Ihrer Daten erfolgt auf Grundlage unseres berechtigten Interesses gemäß Art. 6 Abs. 1 lit. f DSGVO, um mit Nutzern zu kommunizieren und unser Angebot zu verbessern.
<br /><br />
e. Ihre Rechte
<br />
Sie haben das Recht auf Auskunft, Berichtigung, Löschung, Einschränkung der Verarbeitung sowie das Recht auf Datenübertragbarkeit Ihrer personenbezogenen Daten. Zudem steht Ihnen ein Widerspruchsrecht gegen die Verarbeitung zu. Bei Anliegen können Sie sich sowohl an uns als auch direkt an Meta wenden.
<br /><br />
6. Weitere Informationen
<br />
Bitte beachten Sie, dass wir keinen Einfluss auf die Datenverarbeitung durch Meta haben. Weitere Informationen finden Sie in der <a href="https://de-de.facebook.com/about/privacy/update" target="_blank">Datenschutzrichtlinie von Facebook</a> und der <a href="https://help.instagram.com/519522125107875" target="_blank">Datenschutzrichtlinie von Instagram</a>.
<br /><br />
Durch die Nutzung unserer Social-Media-Profile erklären Sie sich mit der Verarbeitung Ihrer Daten gemäß dieser Datenschutzerklärung einverstanden.
            ...
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">6b. X (vormals Twitter)</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret" class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
Im Rahmen unserer Datenschutzerklärung möchten wir Sie über die Verarbeitung personenbezogener Daten im Zusammenhang mit unseren Präsenzen auf X (vormals Twitter) informieren.
<br /><br />
a. Allgemeines
<br />
Unsere Social-Media-Profile auf X (vormals Twitter) dienen der Präsentation von PflegePur und der Interaktion mit Nutzern. Bitte beachten Sie, dass bei der Nutzung dieser Plattformen personenbezogene Daten durch die jeweiligen Anbieter verarbeitet werden.
<br /><br />
b. Verantwortliche Stellen
<br />
Für die Datenverarbeitung im Zusammenhang mit unseren Social-Media-Profilen sind wir gemeinsam mit X Corp., 1355 Market Street, Suite 900, San Francisco, CA 94103, USA bzw. Twitter International Unlimited Company, One Cumberland Place, Fenian Street, Dublin 2, D02 AX07, Ireland verantwortlich.
<br /><br />
c. Datenverarbeitung und Zwecke
<br />
Bei Besuch unserer Profile erfasst Meta sogenannte Insights-Daten, die uns in anonymisierter Form zur Verfügung gestellt werden. Diese Daten ermöglichen es uns, die Nutzung unserer Profile zu analysieren und unser Angebot zu verbessern. Wir haben keinen Zugriff auf personenbezogene Daten einzelner Nutzer.
...
6. Weitere Informationen
<br />
Bitte beachten Sie, dass wir keinen Einfluss auf die Datenverarbeitung durch Meta haben. Weitere Informationen finden Sie in der <a href="https://x.com/de/privacy" target="_blank">Datenschutzrichtlinie von X</a>.
<br /><br />
Durch die Nutzung unserer Social-Media-Profile erklären Sie sich mit der Verarbeitung Ihrer Daten gemäß dieser Datenschutzerklärung einverstanden.
            ...
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">6c. YouTube-Videos</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret" class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
...
Weitere Informationen zum Umgang von Nutzerdaten finden Sie in der Datenschutzerklärung von YouTube unter: <a href="https://www.google.de/intl/de/policies/privacy" target="_blank">www.google.de/intl/de/policies/privacy</a>
...
Wir haben auf unserer Website YouTube-Videos integriert. YouTube Video ist eine Komponente der Videoplattform der YouTube, LLC, auf der Nutzer Inhalte hochladen, über das Internet teilen und detaillierte Statistiken erhalten können. YouTube Video ermöglicht es uns, auf einfache Weise Inhalte der Plattform in unsere Website zu integrieren.
<br /><br />
Wenn Sie auf Webseiten mit integrierten YouTube Videos zugreifen, stellen Sie eine Verbindung zu Servern der YouTube, LLC, Google Ireland Limited, Gordon House, Barrow Street Dublin 4, Irland her, wobei Ihre IP-Adresse und ggf. Browserdaten wie Ihr User-Agent übermittelt werden. YouTube Video wird unter Umständen versuchen, Sie wiederzuerkennen und Nutzerprofile zu erstellen. Wenn Sie bei YouTube, LLC registriert sind, kann YouTube Video die abgespielten Videos Ihrem Profil zuordnen.
<br /><br />
Die Nutzung von YouTube und damit die Übermittlung Ihrer IP-Adresse an Google erfolgt auf Grundlage unseres berechtigten Interesses (Art. 6 Abs. 1 lit. f DSGVO), unsere Webseiten technisch professionell, sicher und zukunftsfähig umzusetzen und zu betreiben.
<br /><br />
Google Ireland ist Teil des amerikanischen Alphabet-Konzerns. Ob und welche Daten Google Ireland aus dem Geltungsbereich der DSGVO an ihre Konzernmutter in den USA übermittelt, ist uns nicht bekannt. Sofern eine solche Übermittlung erfolgt, ist hierfür ausschließlich YouTube LLC verantwortlich. Darüber hinaus wäre eine solche Übermittlung der IP-Adresse in den Drittstaat USA auch zulässig, da für die USA mit dem EU-U.S. Data Privacy Framework (DPF) ein sog. Angemessenheitsbeschluss gem. Art. 45 Abs. 1 DSGVO vorliegt und die Google-Unternehmen sich per Selbstzertifizierung dessen Bedingungen unterworfen haben.
<br /><br />
Wir speichern im Zusammenhang mit der Nutzung von YouTube Video keine Daten; ob und wie lange Google die IP-Adresse und ggf. weitere im Zuge des Abrufs der erhobene Daten speichert, darüber können Sie sich auf den Seiten von Google/YouTube informieren.                                
                </div>
            </div>            
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">6d. Jotform</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret" class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
Auf unserer Website nutzen wir im Rahmen von Kontaktanfragen die Dienste der Jotform Inc. (111 Pine St. Suite 1815 San Francisco CA 94111, USA). Die über diese aufgerufenen Formulare versendeten Daten werden SSL-verschlüsselt zu in Europa (Deutschland) liegenden Servern der Firma Jotform übertragen und dort gespeichert. Im Anschluss verarbeiten wir die Daten, die Sie uns im Rahmen der Formulare mitteilen. Dies können beispielsweise Ihr Vor- und Nachname, Ihre Telefonnummer, Ihre Adresse oder Angaben zu Ihrem Studienwunsch sein. Wir haben mit Jotform einen Auftragsverarbeitungsvertrag (AVV) abgeschlossen, in dem wir Jotform verpflichten, die Daten unserer Kunden zu schützen und sie nicht an Dritte weiterzugeben. Näheres zum Datenschutz und zur DSG-VO-Konformität von Jotform finden Sie unter <a href="https://www.jotform.com/privacy" target="_blank">https://www.jotform.com/privacy</a> bzw. <a href="https://eu.jotform.com/gdpr-compliance" target="_blank">eu.jotform.com/gdpr-compliance</a>. Eine Erklärung von Jotform zur Speicherung der Daten auf Servern in der EU finden Sie hier: <a href="https://www.jotform.com/blog/eu-safe-harbor/" target="_blank">www.jotform.com/blog/eu-safe-harbor/</a>
            ...
            <div class="impressum-section1-accordion1">
                ...
                <div class="impressum-accordion1-bottom-div ">
                    ...
                    <br>
                    Wenn Ihr Browser Web Fonts nicht unterstützt, wird eine Standardschrift von Ihrem Computer genutzt. Weitere Informationen zu Google Web Fonts finden Sie unter<br />
                    https://www.developers.google.com/fonts/faq .
                </div>
            </div>
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">9. Einsatz von Google AdSense</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret"
                        class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
                    ...
                    <br>
                    Sie können die Installation der Cookies von Google AdSense auf verschiedene Weise verhindern:<br />
                    ...
                    b) durch Deaktivierung der interessenbezogenen Anzeigen bei Google über den Link www.google.de/ads/preferences, wobei diese Einstellung gelöscht wird, wenn Sie Ihre Cookies löschen;<br />
                    c) durch Deaktivierung der interessenbezogenen Anzeigen der Anbieter, die Teil der Selbstregulierungs-Kampagne „About Ads“ sind, über den Link www.aboutads.info/choices, wobei diese Einstellung gelöscht wird, wenn Sie Ihre Cookies löschen;<br />
                    d) durch dauerhafte Deaktivierung in Ihren Browsern Firefox, Internetexplorer oder Google Chrome unter dem Link www.google.com/settings/ads/plugin.<br /><br />
                    ...
                    <br />
                    Datenschutzbedingungen für Werbung: www.google.de/intl/de/policies/technologies/ads. Google hat sich dem EU-US Privacy Shield unterworfen, www.privacyshield.gov/EU-US-Framework.
                </div>
            </div>
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">10. Einsatz von AdCell</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret"
                        class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
            ...
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">11. Einsatz von Matomo</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret"
                        class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
            ...
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">12. Newsletter</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret"
                        class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
            ...
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">13. Amazon-Partnerprogramm</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret"
                        class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
            ...
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">14. Betroffenenrechte</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret"
                        class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
            ...
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">15. Widerspruchsrecht</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret"
                        class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
            ...
            <div class="impressum-section1-accordion1">
                <div class="impressum-accordion1-top-div">
                    <div class="impressum-accordion1-heading ">16. Datensicherheit</div>
                    <img src="{{ asset('assets/Images/Blog_caret_down.svg') }}" alt="caret"
                        class="accordion-icon ">
                </div>
                <div class="impressum-accordion1-bottom-div ">
